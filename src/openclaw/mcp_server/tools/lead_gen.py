...
from openclaw.services.website_audit import (
    fetch_page as _fetch_page,
    normalize_url as _normalize_url,
    detect_tech_stack as _detect_tech_stack,
    extract_site_problems as _extract_site_problems,
    score_website_quality as _score_website_quality,
    extract_brand_colors as _extract_brand_colors,
    extract_contact_emails as _extract_contact_emails,
)
