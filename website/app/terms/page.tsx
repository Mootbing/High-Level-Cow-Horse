      ...
      <div className="container" style={{ maxWidth: 720, paddingTop: "clamp(6rem, 12vh, 10rem)", paddingBottom: "clamp(4rem, 8vh, 6rem)" }}>
        ...
        {[
          ...
          },
          {
            ...
            body: "Our standard pricing is $250 one-time for website design and development, plus $50/month for hosting, maintenance, and ongoing revisions. You don't pay until you're satisfied with the design. Monthly fees are billed on the first of each month. All prices are in USD.",
          },
          {
            title: "Revisions",
