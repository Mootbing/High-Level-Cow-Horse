"""Outbound Email Skill — drafts personalized cold emails via Gmail for
owner approval.

Ported from openclaw.agents.outbound.OutboundAgent.
"""
...
class OutboundSkill(BaseSkill):
    name = "outbound"
    description = "Drafts personalized cold emails via Gmail for owner approval"
    tier = "light"
