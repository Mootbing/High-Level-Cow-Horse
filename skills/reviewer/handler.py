"""Reviewer Skill — validates every step of the pipeline before proceeding."""
...
class ReviewerSkill(BaseSkill):
    name = "reviewer"
    description = "Validates every step of the pipeline before proceeding"
    tier = "light"
    ...
    async def execute(self, context: SkillContext) -> SkillResult:
        """Run review and prepend machine-readable verdict line for PM pipeline gating."""
        ...
        return SkillResult(
            success=True,
            result=result_text,
            data={"status": "completed", "result": result_text},
        )
