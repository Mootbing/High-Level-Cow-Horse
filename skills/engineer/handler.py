...
class EngineerSkill(BaseSkill):
    name = "engineer"
    description = "Builds Next.js websites with GSAP animations, deploys to Vercel"
    tier = "heavy"
    ...
    async def execute(self, context: SkillContext) -> SkillResult:
        ...
        if not self._current_project_id:
            self._current_project_id = context.payload.get("project_id")
